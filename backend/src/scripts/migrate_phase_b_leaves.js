...
async function runMigration() {
  try {
    console.log('Running Leave Applications migration on Hostinger MySQL database...');
    ...
    // Also check if attendance status ENUM supports 'ON_LEAVE' or if we can insert/update it safely
    console.log('✓ Successfully created `leave_applications` table with indexes and constraints.');
    process.exit(0);
  } catch (error) {
