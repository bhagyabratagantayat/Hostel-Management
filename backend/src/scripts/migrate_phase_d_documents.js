...
async function runMigration() {
  try {
    console.log('Running Document Requests migration on Hostinger MySQL database...');
    ...
    console.log('✓ Successfully created `document_requests` table with indexes and constraints.');
    process.exit(0);
  } catch (error) {
